...
public class SimulacaoGrafica extends Simulation {
    ...
    public SimulacaoGrafica(SimulationProgress janela, JLabel tempo, RedeDeFilas redeDeFilas, List<Tarefa> tarefas, double sleep) throws IllegalArgumentException {
