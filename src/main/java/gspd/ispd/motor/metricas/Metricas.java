...
public class Metricas implements Serializable {
    ...
    /**
     * The list of users. Each user is represented by a String
     */
    private List<String> usuarios;
    /**
     * Associates each user with its ComunicationMetrics
     */
    private Map<String, MetricasComunicacao> metricasComunicacao;
    /**
     * Associates each user with its ProcessingMetrics
     */
    private Map<String, MetricasProcessamento> metricasProcessamento;
    /**
     * Associates each user with its AlocationMetrics
     */
    private Map<String, MetricasAlocacao> metricasAlocacao;
    /**
     * Associates each user with its CostMetrics
     */
    private Map<String, MetricasCusto> metricasCusto;
    /**
     * Associates each user with its SatisfactionMetrics
     */
    private Map<String, Double> metricasSatisfacao;
    /**
     * Associates each user with its ConcludedTasks
     */
